...
describe("Test The First Character is Capital", () => {
    it("String Return ?", () => { expect(typeof capitalizeTextFirstChar("test test test")).toBe("string")
    })
    it("Capital ?", () => { expect(capitalizeTextFirstChar("test test")).toBe("test test")
    })
...
describe("test text reversing fun", () => {
    ...
    it("the same length", () => { expect(stringReverse("test")).toHaveSize("test".length)
    })
})